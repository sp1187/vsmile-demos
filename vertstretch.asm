...
; print out numbers in each line of tilemap for easier verification

ld r2, #'0'
ld r3, #(tilemap + 64*0 + 3)
print_numbers:
st r2, [r3]
add r3, r3, #64
add r2, #1
